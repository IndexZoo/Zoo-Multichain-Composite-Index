...
export interface IntegrationRegistryMockInterface extends utils.Interface {
  contractName: "IntegrationRegistryMock";
  functions: {
...
export interface IntegrationRegistryMock extends BaseContract {
  contractName: "IntegrationRegistryMock";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IntegrationRegistryMockInterface;
