...
export interface SetTokenCreatorMockInterface extends utils.Interface {
  contractName: "SetTokenCreatorMock";
  functions: {
...
export interface SetTokenCreatorMock extends BaseContract {
  contractName: "SetTokenCreatorMock";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SetTokenCreatorMockInterface;
