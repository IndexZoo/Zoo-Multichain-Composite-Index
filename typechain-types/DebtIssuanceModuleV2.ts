...
export interface DebtIssuanceModuleV2Interface extends utils.Interface {
  contractName: "DebtIssuanceModuleV2";
  functions: {
...
export interface DebtIssuanceModuleV2 extends BaseContract {
  contractName: "DebtIssuanceModuleV2";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DebtIssuanceModuleV2Interface;
